...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post payment_methods_url, params: { payment_method: { description: @payment_method.description, name: @payment_method.name } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { description: @payment_method.description, name: @payment_method.name } }
